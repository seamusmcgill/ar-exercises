...
@store1.employees.create(first_name: "Nambo", last_name: "Noodle", hourly_rate: 40)
@store1.employees.create(first_name: "Jeff", last_name: "Johns", hourly_rate: 45)
@store2.employees.create(first_name: "Cleetus", last_name: "Frampel", hourly_rate: 50)
...
@store2.employees.create(first_name: "Wendy", last_name: "Floop", hourly_rate: 70)
